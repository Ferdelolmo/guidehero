...
export const cataniaPoints: PointOfInterest[] = [
  ...
  {
    id: 'ristorante-terrazza-barone',
    name: text({
      en: 'Ristorante Trattoria La terrazza del barone',
      es: 'Ristorante Trattoria La terrazza del barone',
      it: 'Ristorante Trattoria La terrazza del barone',
      pt: 'Ristorante Trattoria La terrazza del barone',
      fr: 'Ristorante Trattoria La terrazza del barone',
    }),
    description: text({
      en: 'Typical place to eat and taste horse meat and Sicilian wines, cheap and not so touristic',
      es: 'Lugar típico para comer y degustar carne de caballo y vinos sicilianos, económico y no tan turístico',
      it: 'Posto tipico per mangiare e degustare carne di cavallo e vini siciliani, economico e non tanto turistico',
      pt: 'Lugar típico para comer e saborear carne de cavalo e vinhos sicilianos, barato e não tão turístico',
      fr: 'Lieu typique pour manger et déguster de la viande de cheval et des vins siciliens, bon marché et pas si touristique',
    }),
    coordinates: [37.5001, 15.0809],
    category: 'eat',
    duration: 0,
    order: 14,
    images: [],
    audioUrl: text({ en: '', es: '', it: '', pt: '', fr: '' }),
    price: 'Economic',
    googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Ristorante+Trattoria+La+terrazza+del+barone',
    extendedSections: [
      {
        paragraphs: [
          text({
            en: 'Typical place to eat horse meat, cheap prices and good and fast service',
            es: 'Lugar típico para comer carne de caballo, precios económicos y servicio bueno y rápido',
            it: 'Posto tipico per mangiare carne di cavallo, prezzi economici e servizio buono e veloce',
            pt: 'Lugar típico para comer carne de cavalo, preços baratos e serviço bom e rápido',
            fr: 'Endroit typique pour manger de la viande de cheval, des prix bon marché et un service bon et rapide',
          }),
        ],
      },
    ],
  ...
  {
    id: 'parcheggio-bellini',
    name: text({
      en: 'Parcheggio Bellini',
      es: 'Aparcamiento Bellini',
      it: 'Parcheggio Bellini',
      pt: 'Estacionamento Bellini',
      fr: 'Parking Bellini',
    }),
    description: text({
      en: 'Convenient parking near Villa Bellini and Via Etnea.',
      es: 'Aparcamiento conveniente cerca de Villa Bellini y Via Etnea.',
      it: 'Parcheggio comodo vicino a Villa Bellini e Via Etnea.',
      pt: 'Estacionamento conveniente perto da Villa Bellini e da Via Etnea.',
      fr: 'Parking pratique près de la Villa Bellini et de la Via Etnea.',
    }),
    coordinates: [37.509, 15.088],
    category: 'park',
    duration: 0,
    order: 15,
    images: [],
  ...
  },
  {
    ...
    description: text({
      en: 'Horse Meat and typical sicilian food',
      es: 'Carne de caballo y comida típica siciliana',
      it: 'Carne di cavallo e cibo tipico siciliano',
      pt: 'Carne de cavalo e comida típica siciliana',
      fr: 'Viande de cheval et cuisine sicilienne typique',
    }),
    // Approximate coordinates, actual restaurant is on the piazza
    coordinates: [37.5011, 15.0879],
    category: 'eat',
    duration: 0,
    order: 16,
    ...
    audioUrl: text({ en: '', es: '', it: '', pt: '', fr: '' }),
    price: 'Fair',
    googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Camelot+P.za+Federico+di+Svevia,+73,+95121+Catania+CT,+Italia',
    extendedSections: [],
  },
  {
    id: 'trattoria-del-cavaliere',
    name: text({
      en: 'Trattoria del Cavaliere',
      es: 'Trattoria del Cavaliere',
      it: 'Trattoria del Cavaliere',
      pt: 'Trattoria del Cavaliere',
      fr: 'Trattoria del Cavaliere',
    }),
    description: text({
      en: 'Economic',
      es: 'Económico',
    ...
    coordinates: [37.5067804, 15.0873238],
    category: 'eat',
    duration: 0,
    order: 17,
    images: [],
    audioUrl: text({ en: '', es: '', it: '', pt: '', fr: '' }),
    price: 'Economic',
    googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Trattoria+del+Cavaliere+Via+Paternò,+11,+95131+Catania+CT,+Italia',
    extendedSections: [],
  },
];
